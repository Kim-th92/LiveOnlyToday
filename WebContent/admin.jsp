...
<h1>관리자 페이지</h1>
<div id ="adminview">
	<h2>가입자 조회<button onclick="location.href='move.do?command=adminview'">회원 전체 조회</button></h2>
...
<div id="qnaboard">
	<h2>문의게시판 관리<button onclick="location.href='move.do?command=qnaboard'">문의내역 전체 보기</button></h2>
</div>
