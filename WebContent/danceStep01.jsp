...
<script type="text/javascript">
    ...
    async function predict() {
        ...
        if(prediction[0].className == "Up" && prediction[0].probability.toFixed(2) == 1.00 ) {
        	labelContainer.childNodes[0].innerHTML = "<img src='./resources/img/danceModel/monkeyStep01.png'/>"
		} else if(prediction[1].className == "Down" && prediction[1].probability.toFixed(2) == 1.00 ) {
			labelContainer.childNodes[0].innerHTML = "<img src='./resources/img/danceModel/monkeyStep01_01.png'/>"
		}
